...
public class InfixToPostfix {
     ...
     *  However, the process does not account for negative numbers.
     *
     *  @param  infix The mathamatical expression in string form.
     ...
     *
     *   @return PostfixIterator to be used as the overridden 
     */
