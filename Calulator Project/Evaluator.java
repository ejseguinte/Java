...
public class Evaluator {
    private Map<String,String> variable; //Holds the variable mapped to values
    ...
    /** This method in <tt>Evaluator</tt> processes the other mathamatical expressions besides variables.
   ...
   public String math(InfixToPostfix postfix){
    ...
    /** This is used as an operand comparison for <tt>Evaluator</tt> objects' that takes 3 values
      * converting the first two values into Big Integer and evaluates them with the operand. Since the Big Integer's
   ...
   public String operation (String num1, String num2, String operator){
    ...
    /** Simple embedded unit-test for <tt>Evaluator</tt> Class.
